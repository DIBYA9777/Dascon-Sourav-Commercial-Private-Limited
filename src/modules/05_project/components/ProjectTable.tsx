    ...
    <div className="bg-white rounded-2xl border border-slate-100 shadow-xs overflow-hidden">
      <div className="overflow-x-auto">
        <table className="w-full text-left border-collapse">
          <thead>
            <tr className="bg-slate-50/50 border-b border-slate-100 selection:bg-slate-100">
              <th 
                onClick={() => onSort('code')}
      ...
      {/* Pagination Bar */}
      {totalPages > 1 && (
        <div className="p-4 bg-slate-50/50 border-t border-slate-101 flex items-center justify-between">
